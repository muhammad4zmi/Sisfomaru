        ...
        <div class="col-md-12">
            <div class="card mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary text-uppercase" style="font-size: 14px;">Tambah Informasi PMB</h6>
                </div>
                <div class="card-body">
                    ...
                    <form class="user" method="POST" action="/informasi/save">
                        ...
                        <div class="col-md-12">
                            <div class="text-left">
                                <a href="informasi" class="btn btn-sm btn-danger" name="kembali">
