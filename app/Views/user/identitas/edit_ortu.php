                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="telepon_ayah" id="telepon_ayah" class="form-control" value="<?= $k['telepon_ayah']; ?>" style="font-size: 12px;">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="telepon_ibu" id="telepon_ibu" class="form-control" value="<?= $k['telepon_ibu']; ?>" style="font-size: 12px;">
                                        </div>
