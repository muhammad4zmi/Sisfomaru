...
<head>
    ...
    <meta name="description" content="Aplikasi Pendaftaran Mahasiswa Baru STMIK Syaikh Zainuddin NW Anjani">
    <meta name="author" content="Syaifuddin Zuhri">

    <title><?= $title; ?> - STMIK Syaikh Zainuddin NW Anjani</title>
    <!-- Gambar title -->
...
<body class="register">
    ...
    <script src="<?= base_url(); ?>/admin/assets/js/style/js/plugins/pace.min.js"></script>
